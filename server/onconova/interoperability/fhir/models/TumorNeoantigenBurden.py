# Code autogenerated by Fhircraft 0.5.0 on 2026-04-15 15:32:49.939119.
...
class OnconovaTumorNeoantigenBurdenValueQuantity(Quantity):
    """
    ...
    code: Optional[fhir.code] = Field(
        ...
        default_factory=lambda: '1/1000000{Neoantigen}',
    )
...
class OnconovaTumorNeoantigenBurden(GenomicsBase):
    ...
    valueQuantity: Optional[OnconovaTumorNeoantigenBurdenValueQuantity] = Field(
        description="The information determined as a result of making the observation, if the information has a simple value.",
        default=None,
    )

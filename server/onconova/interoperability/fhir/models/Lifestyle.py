# Code autogenerated by Fhircraft 0.4.1 on 2025-12-04 08:15:07.318168.
...
class OnconovaLifestyleUsCore(CodeableConcept, FHIRSliceModel):
    """
...
class OnconovaLifestyleSmokingStatus(BackboneElement, FHIRSliceModel):
    ...
    referenceRange: Optional[
        List[OnconovaLifestyleSmokingStatusComponentReferenceRange]
    ] = Field(

# Code autogenerated by Fhircraft 0.5.0 on 2026-04-15 15:32:46.700279.
...
class OnconovaAneuploidScoreValueQuantity(Quantity):
    """
...
class OnconovaAneuploidScore(GenomicsBase):
    ...
    valueQuantity: Optional[OnconovaAneuploidScoreValueQuantity] = Field(
        description="The information determined as a result of making the observation, if the information has a simple value.",
        default=None,
    )

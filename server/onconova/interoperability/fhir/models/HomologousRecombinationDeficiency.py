# Code autogenerated by Fhircraft 0.5.0 on 2026-04-15 15:32:50.292548.
...
class OnconovaHomologousRecombinationDeficiencyValueQuantity(Quantity):
    """
...
class OnconovaHomologousRecombinationDeficiency(GenomicsBase):
    ...
    valueQuantity: Optional[OnconovaHomologousRecombinationDeficiencyValueQuantity] = Field(
        description="The information determined as a result of making the observation, if the information has a simple value.",
        default=None,
    )
